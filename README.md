...
Простой RESTful сервис для управления списком задач (TodoList), реализованный на **Spring Boot**. Проект подходит для
изучения основ создания REST API с использованием Spring, JPA, H2 и Maven.
